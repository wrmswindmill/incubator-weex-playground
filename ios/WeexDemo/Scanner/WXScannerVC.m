...
@interface WXScannerVC () <UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    self.data = @[@[@"AnimationTest",@"http://dotwe.org/raw/dist/72cceeabfe0430e796e1f9874061dd93.bundle.wx?_wx_tpl=http://dotwe.org/raw/dist/72cceeabfe0430e796e1f9874061dd93.bundle.wx"],@[@"OtherTest",@"http://dotwe.org/raw/dist/dbc70aa189257a121b66c1095993f24f.bundle.wx?_wx_tpl=http://dotwe.org/raw/dist/dbc70aa189257a121b66c1095993f24f.bundle.wx"]
                  ];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text =  [self.data objectAtIndex:indexPath.row][0];
    return cell;
}
...
{
    NSString* symbol = [self.data objectAtIndex:indexPath.row][0];
    NSString* url = [self.data objectAtIndex:indexPath.row][1];
    [self openURL:url with:symbol];
}
...
- (void)openURL:(NSString*)URL with:(NSString*)symbol{
