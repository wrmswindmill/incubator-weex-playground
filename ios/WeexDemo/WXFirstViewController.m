...
- (void)loadData {
    self.data = @[
      [[TestTask alloc] initWithName:@"AnimationTest" url:@"http://dotwe.org/vue/72cceeabfe0430e796e1f9874061dd93"]
    ];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath;{
    TestTask* task = [self.data objectAtIndex:indexPath.row];
    WXDemoViewController * controller = [[WXTestViewController alloc] initWithName:task.url symbol:task.name];
